...
urlpatterns = [
    ...
    url(r'^password/reset/$',
	   ...
	   auth_views.PasswordResetView, # LAM: Changed for version 2.0
    ...
    url(r'^password/reset/done/$',
	   ...
	   auth_views.PasswordResetDoneView, # LAM: Changed for version 2.0
       {'template_name': 'userena/password_reset_done.html',},
       name='userena_password_reset_done'),
    url(r'^password/reset/confirm/(?P<%s>[0-9A-Za-z]+)-(?P<token>.+)/$' % password_reset_uid_kwarg,
       #auth_views.password_reset_confirm,
	   auth_views.PasswordResetConfirmView, # LAM: Changed for version 2.0
    ...
    url(r'^password/reset/confirm/complete/$',
	   ...
	   auth_views.PasswordResetCompleteView, # LAM: Changed for version 2.0
